...
read_tools_menu.addCommand('Set nodes localization', 'read_knobs.setLocalize()')
read_tools_menu.addCommand('Set read nodes frame range', 'read_knobs.setFrameRange()')
read_tools_menu.addCommand('Missing frames setting', 'read_knobs.setError()')
